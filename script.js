(function () {
    ...
    function closeWaitlistOverlay(e) {
        if (e.target === document.getElementById('waitlist-modal')) {
            closeWaitlist();
        }
    }
    ...
    function submitWaitlist(e) {
        ...
        fetch('https://api.web3forms.com/submit', {
            ...
            body: JSON.stringify({
                access_key: '7126317f-d6eb-4d40-b7e2-00b5b6c05273',
                name:       name,
                email:      email,
                subject:    'New Waitlist Signup — Cyberronin'
            })
        })
    ...
    window.closeWaitlistOverlay  = closeWaitlistOverlay;
